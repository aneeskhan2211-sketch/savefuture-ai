import { j as jsxRuntimeExports, t as commonjsGlobal, m as getDefaultExportFromCjs, r as reactExports, l as clsx, R as React, v as invariant } from "./index-DyUgiqXz.js";
import { C as Card } from "./card-vMn3-AtH.js";
const bgMap = {
    ...
    Card,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body truncate", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground leading-tight", children: value }),
          subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground truncate", children: subtitle })
        ] })
      ]
    }
  );
...
export {
  ...
  getMaxRadius as t,
  uniqueId as u,
  getPercentValue as v,
  warn as w,
  hasClipDot as x,
  getCateCoordinateOfLine as y,
