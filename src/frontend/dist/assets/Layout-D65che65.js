import { w as useRouterState, j as jsxRuntimeExports, L as Link, r as reactExports, x as React, y as ReactDOM, i as cn, R as React$1, a as useInternetIdentity } from "./index-DyUgiqXz.js";
import { c as createLucideIcon, a as Briefcase, L as Lightbulb, S as Sparkles, u as useComposedRefs, T as TrendingUp, B as Button } from "./trending-up-CtEt7QQ9.js";
import { e as useLayoutEffect2, d as useCallbackRef$1, P as Primitive, b as composeEventHandlers, g as dispatchDiscreteCustomEvent, a as Presence, c as createContextScope, f as createSlot, h as createContext2, X, u as useSubscription } from "./useSubscription-DmQaFjSs.js";
/**
...
const NAV_ITEMS = [
  { to: "/", icon: House, label: "Home", ocid: "mobile_nav.home_link" },
  {
    to: "/dashboard",
...
function MobileBottomNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-around px-2 py-2 safe-area-inset-bottom", children: NAV_ITEMS.map(({ to, icon: Icon, label, ocid }) => {
        const isActive = to === "/" ? currentPath === "/" : currentPath.startsWith(to);
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to,
            className: `flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-lg transition-smooth ${isActive ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground"}`,
            "data-ocid": ocid,
            "aria-label": label,
            children: [
...
function PremiumBadge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      className: `inline-flex items-center gap-1 rounded-full font-semibold ${size === "sm" ? "text-xs px-2 py-0.5" : "text-sm px-3 py-1"} bg-accent/15 text-accent border border-accent/30`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: size === "sm" ? "w-3 h-3" : "w-4 h-4" }),
        label
      ]
    }
  );
...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = React$1.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = React$1.useRef(0), U2 = React$1.useRef(0), St = React$1.useRef(0), K = React$1.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$1.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
...
function Layout({ children, showBottomNav = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 bg-card border-b border-border shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex items-center justify-between h-14 px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: "/",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-base", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "SaveFuture" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "nav",
        {
          ...
          children: NAV_LINKS.map(({ to, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        isPremium && /* @__PURE__ */ jsxRuntimeExports.jsx(PremiumBadge, {}),
        ...
        !isPremium && isLoggedIn && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/premium", className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            size: "sm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: mobileOpen, onOpenChange: setMobileOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "w-72 bg-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1", children: NAV_LINKS.map(({ to, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to,
                onClick: () => setMobileOpen(false),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-border", children: isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "hidden md:block bg-card border-t border-border py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground", children: "SaveFuture AI" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "— Save Money. Build Career. Secure Your Future." })
      ] }),
    ...
    showBottomNav && /* @__PURE__ */ jsxRuntimeExports.jsx(MobileBottomNav, {}),
